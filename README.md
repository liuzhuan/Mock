...
Mock.js is a simulation data generator to help the front-end to develop and prototype separate from the back-end progress and reduce some monotony(千篇一律) particularly while writing automated tests.

The official site: <http://mockjs.com>

## Features

* Generate simulated data according to the data template 根据数据模版生成模拟数据
* Provide request/response mocking for ajax requests 为 ajax 请求提供请求/响应模拟
